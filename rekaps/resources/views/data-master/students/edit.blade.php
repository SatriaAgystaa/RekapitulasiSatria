...
@section('content')
    <div class="bg-white p-4 rounded-lg">
        <div>
            <h1 class="text-3xl font-semibold">Update Student</h1>
        </div>
        ...
        <form action="{{ route('students.update', $student->id) }}" method="POST" class="grid gap-4 pb-5">
            ...
            <button type="submit" class="p-2 rounded-lg text-white bg-black" style="background-color: #0766AD;">Update Student</button>
        </form>
    </div>
@endsection

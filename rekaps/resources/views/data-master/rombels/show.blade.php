...
<div class="p-2 grid items-center rounded-lg gap-3">
    ...
    <div class="text-right">
        ...
        <a href="{{ route('rombels.create') }}" class="text-white p-2 rounded-lg" style="background-color: #0766AD;">
            Tambah Data
        </a>    
        @endif
    </div>
                            ...
                            @if (Auth::user()->role == "admin")
                                <td class="border-gray-400 border-b px-4 py-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a href="{{ route('rombels.edit', $rombel->id) }}" class="rounded-lg p-2 text-white flex items-center" style="background-color: #0766AD;">
